...
void read_clustAlgTTbarHist()
{
   ...
   TFile outFile("/home/ethan/Documents/clustAlgBR_ttbar_processed_4TeVSuu.root","RECREATE");
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   {  
      ...
      if((totHT<4000.)||(nbtaggedAK4<2))continue;

      if((SJ_nAK4_200[0]<2)||(SJ_nAK4_200[1]<2) || (nfatjet_pre < 3) ) continue;
      ntotalevents++;
...
//(diSuperJet_mass_100 < 4000.)
   ...
   c1->SaveAs("clustAlg_ttbar_ETASORT/h_SJ_mass_versus.png");  

   h_nfatjets->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/h_nfatjets.png");  


   h_jet_mass->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/h_jet_mass.png");
   
   h_SJ_mass_versus->Write();

   h_superJet_mass_TH2->Draw("colz");
   c1->SaveAs("clustAlg_ttbar_ETASORT/h_superJet_mass_TH2.png");  

   h_diSuperJet_mass_diag->Draw();
   c1->SaveAs("clustAlg_ttbar_ETASORT/h_diSuperJet_mass_diag.png"); 
   ...
   c1->SaveAs("clustAlg_ttbar_ETASORT/h_SJ_nAK4_100.png");  
   h_SJ_nAK4_200->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/h_SJ_nAK4_200.png");  
   h_SJ_nAK4_400->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/h_SJ_nAK4_400.png");  
   h_SJ_nAK4_600->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/h_SJ_nAK4_600.png");  
   h_SJ_nAK4_800->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/h_SJ_nAK4_800.png");  
   h_SJ_nAK4_1000->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/h_SJ_nAK4_1000.png");  
   h_superJet_mass->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/h_superJet_mass.png");  

   h_SJ_mass_50_versus->Draw("AP*");
   c1->SaveAs("clustAlg_ttbar_ETASORT/h_SJ_mass_50_versus.png"); 

   h_SJ_mass_70_versus->Draw("AP*");
   c1->SaveAs("clustAlg_ttbar_ETASORT/h_SJ_mass_70_versus.png"); 

   h_SJ_mass_50->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/h_SJ_mass_50.png");

   h_SJ_mass_70->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/h_SJ_mass_70.png");

   h_SJ_mass_100->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/h_SJ_mass_100.png"); 

   h_SJ_AK4_50_mass->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/h_SJ_AK4_50_mass.png"); 

   h_SJ_AK4_70_mass->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/h_SJ_AK4_70_mass.png");

   h_AK4_mass->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/h_AK4_mass.png");
