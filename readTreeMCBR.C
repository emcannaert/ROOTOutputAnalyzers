   ...
   for(auto dataYear = dataYears.begin(); dataYear < dataYears.end();dataYear++ )
   {
      ...
      for(auto systematic = systematics.begin();systematic<systematics.end();systematic++)
      {
         ...
         for(auto dataBlock = dataBlocks.begin();dataBlock < dataBlocks.end();dataBlock++)
         {
            ...
            if (inFileName.find("Suu") != std::string::npos) inFileName = ("/Users/ethan/Documents/rootFiles/signalFiles/"+*dataBlock+  year + "_SKIMMED.root").c_str();
            ...
            std::string outFileName = ("/Users/ethan/Documents/rootFiles/processedRootFiles/"+ *dataBlock+year + "_processed.root").c_str();
