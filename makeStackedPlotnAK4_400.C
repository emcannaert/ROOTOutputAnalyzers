...
void makeStackedPlotnAK4_400()
{
  ...
  TH1I *h_HT1000to1500_HT = (TH1I*)f1->Get("h_SJ_nAK4_400");
  TH1I *h_HT1500to2000_HT = (TH1I*)f2->Get("h_SJ_nAK4_400");
  TH1I *h_HT2000toInf_HT = (TH1I*)f3->Get("h_SJ_nAK4_400");
  ...
  TH1I *h_WJetsToLNu = (TH1I*)f9->Get("h_SJ_nAK4_400");
  TH1I *h_WJet_QQ = (TH1I*)f10->Get("h_SJ_nAK4_400");
  TH1I *h_TTToHadronic = (TH1I*)f11->Get("h_SJ_nAK4_400");
  TH1I *h_TTTo2l2nu = (TH1I*)f12->Get("h_SJ_nAK4_400");
  TH1I *h_TTToSemiLeptonic = (TH1I*)f13->Get("h_SJ_nAK4_400");
  ...
  TH1I *h_JetHTA_HT = (TH1I*)f5->Get("h_SJ_nAK4_400");
  TH1I *h_JetHTB_HT = (TH1I*)f6->Get("h_SJ_nAK4_400");
  TH1I *h_JetHTC_HT = (TH1I*)f7->Get("h_SJ_nAK4_400");
  TH1I *h_JetHTD_HT = (TH1I*)f8->Get("h_SJ_nAK4_400");
  ...
  THStack *hs = new THStack("hs","Data vs MC nAK4 (E_{COM} > 400 GeV)");
  ...
  c1->SaveAs("nAK4_400_stack.png"); 

  TH1I *h_BR_combined = new TH1I(*h_QCD_combined);
  h_BR_combined->Add(h_TTbar_combined);
  h_BR_combined->Add(h_WJets_combined);

  std::cout << "There are " << h_JetHT_combined->Integral(0,50) << " data nAK4 400." << std::endl;
  std::cout << "There are " << h_BR_combined->Integral(0,50) << " MC nAK4 400." << std::endl;
  ...
  c1->SaveAs("tot_nAK4_400_ratio.png"); 
