...
void makeStackedPlotDijetMass()
{
  ...
  TH1F *h_HT1000to1500_HT = (TH1F*)f1->Get("h_avg_dijet_mass");
  TH1F *h_HT1500to2000_HT = (TH1F*)f2->Get("h_avg_dijet_mass");
  TH1F *h_HT2000toInf_HT = (TH1F*)f3->Get("h_avg_dijet_mass");
  ...
  TH1F *h_WJetsToLNu = (TH1F*)f9->Get("h_avg_dijet_mass");
  TH1F *h_WJet_QQ = (TH1F*)f10->Get("h_avg_dijet_mass");
  TH1F *h_TTToHadronic = (TH1F*)f11->Get("h_avg_dijet_mass");
  TH1F *h_TTTo2l2nu = (TH1F*)f12->Get("h_avg_dijet_mass");
  TH1F *h_TTToSemiLeptonic = (TH1F*)f13->Get("h_avg_dijet_mass");
  ...
  TH1F *h_JetHTA_HT = (TH1F*)f5->Get("h_avg_dijet_mass");
  TH1F *h_JetHTB_HT = (TH1F*)f6->Get("h_avg_dijet_mass");
  TH1F *h_JetHTC_HT = (TH1F*)f7->Get("h_avg_dijet_mass");
  TH1F *h_JetHTD_HT = (TH1F*)f8->Get("h_avg_dijet_mass");
  ...
  THStack *hs = new THStack("hs","Data vs MC Avg dijet mass; M_{dijet} [GeV]");
  ...
  c1->SaveAs("dijet_mass_avg_stack.png"); 

  TH1F *h_BR_combined = new TH1F(*h_QCD_combined);
  h_BR_combined->Add(h_TTbar_combined);
  h_BR_combined->Add(h_WJets_combined);

  std::cout << "There are " << h_JetHT_combined->Integral(0,50) << " data avg dijet mass." << std::endl;
  std::cout << "There are " << h_BR_combined->Integral(0,50) << " MC avg dijet mass." << std::endl;
  ...
  c1->SaveAs("tot_dijet_mass_ratio.png"); 
