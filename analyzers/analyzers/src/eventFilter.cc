// -*- C++ -*-
//
// Package:    eventFilter/eventFilter
// Class:      eventFilter
// 
/**\class eventFilter eventFilter.cc eventFilter/eventFilter/plugins/eventFilter.cc
...
// member functions
//
bool eventFilter::isgoodjet(const float eta, const float NHF,const float NEMF, const size_t NumConst,const float CHF,const int CHM, const float MUF, const float CEMF)
{
...
///////////////////////////AK4 jets  && HT
   ...
   if( (totHT < 1250.) || (nBtaggedAK4 < 1)) return false;
   ...
   {
      if((iJet->pt() < 500.) || (!(iJet->isPFJet())) || (!isgoodjet(iJet->eta(),iJet->neutralHadronEnergyFraction(), iJet->neutralEmEnergyFraction(),iJet->numberOfDaughters(),iJet->chargedHadronEnergyFraction(),iJet->chargedMultiplicity(),iJet->muonEnergyFraction(),iJet->chargedEmEnergyFraction())) || (iJet->userFloat("ak8PFJetsPuppiSoftDropMass")< 50.)) continue;
      nfatjets++;
      //(iJet->userFloat("ak8PFJetsPuppiSoftDropMass")< 25.)
   }
   if(nfatjets < 2) return false;
...
void
eventFilter::beginStream(edm::StreamID)
{
}

// ------------ method called once each stream after processing all runs, lumis and events  ------------
void
eventFilter::endStream() {
}

// ------------ method called when starting to processes a run  ------------
/*
void
eventFilter::beginRun(edm::Run const&, edm::EventSetup const&)
{ 
}
*/
...
/*
void
eventFilter::endRun(edm::Run const&, edm::EventSetup const&)
{
}
*/
...
/*
void
eventFilter::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
/*
void
eventFilter::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}
*/
...
void
eventFilter::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
