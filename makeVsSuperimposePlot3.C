...
void makeVsSuperimposePlot3()
{
  ...
  TGraph *h_mChichi_vs_Mchi_SJ1 =  (TGraph*)f1->Get("h_Mchichi_vs_Mchi_SJ1_diag");
  TGraph *h_Mchichi_Mchi_SJ1 = (TGraph*)f2->Get("h_Mchichi_vs_Mchi_SJ1_diag");
  ...
  mg->SetTitle("M_{chi chi} vs SuperJet 1 M_{chi} (Events along SJ1/SJ2 diagonal)");
  ...
  legend3->AddEntry(h_mChichi_vs_Mchi_SJ1,"S_{uu} -> Chi Chi","p");
  legend3->AddEntry(h_Mchichi_Mchi_SJ1,"2018 UL QCD MC (HT > 2000 GeV)","p");
  legend3->Draw();

  c1->SaveAs("M_chichi_vs_Mchi_superposition_diag.png");  
}
