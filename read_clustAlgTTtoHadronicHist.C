...
void read_clustAlgTTtoHadronicHist()
{
   ...
   TFile *f = new TFile("ClusteringAlgorithmBR_ttbar_output.root");
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   h_SJ_mass_versus->SetTitle("SuperJet 1 Mass vs SuperJet 2 Mass (ttbar");
   ...
   double scaleFactor_TTtoHadronic = 0.2938049814;       //for ttbar
   //double scaleFactor_TTtoHadronic = 0.2895;
   ...
   //double cut_totHT = 4000.; int cut_nbtaggedAK4 =2;int cut_SJ1_nAK4_200 = 2;int cut_SJ2_nAK4_200 = 2;int cut_nfatjet_pre =3; double cut_SJ1_mass_100 = 500.;double cut_SJ2_mass_100 = 500.;   // 
   ...
   {  
      t1->GetEntry(i);
      //if((totHT>cut_totHT)&&(nbtaggedAK4>=cut_nbtaggedAK4) && (nfatjet_pre >=cut_nfatjet_pre))
      ...
      {
         if(    (superJet_mass[0]>350.)&&(superJet_mass[1]>350.) ) h_superJet_mass_TH2->Fill(superJet_mass[0],superJet_mass[1]);
         ...
         if( (superJet_mass[0]/superJet_mass[1] < 1.40)&&(superJet_mass[0]/superJet_mass[1] > 0.6)     )
         {
            ...
            h_superJet_mass_pre->Fill(superJet_mass[0],scaleFactor_TTtoHadronic);
            h_superJet_mass_pre->Fill(superJet_mass[1],scaleFactor_TTtoHadronic);
            h_diSuperJet_mass_pre->Fill(diSuperJet_mass,scaleFactor_TTtoHadronic);


            h_diSuperJet_mass_100->Fill(diSuperJet_mass_100,scaleFactor_TTtoHadronic);

         
            h_superJet_mass_comb->Fill(daughter_mass_comb[0],scaleFactor_TTtoHadronic);
            h_superJet_mass_comb->Fill(daughter_mass_comb[1],scaleFactor_TTtoHadronic);
            h_diSuperJet_mass_comb->Fill(resonance_mass_comb,scaleFactor_TTtoHadronic);


            h_SJ_mass_50_pre->Fill(SJ_mass_50[0],scaleFactor_TTtoHadronic);
            h_SJ_mass_50_pre->Fill(SJ_mass_50[1],scaleFactor_TTtoHadronic);

            h_SJ_mass_100_pre->Fill(SJ_mass_100[0],scaleFactor_TTtoHadronic);
            h_SJ_mass_100_pre->Fill(SJ_mass_100[1],scaleFactor_TTtoHadronic);
         }
      }
      nevents_pre++;
      if( (totHT>=cut_totHT) )
      {
         nPassed_totHT+= scaleFactor_TTtoHadronic;
         if (nbtaggedAK4>=cut_nbtaggedAK4)
         {
            nPassed_btagged_AK4+=scaleFactor_TTtoHadronic;
            if( nfatjet_pre >= cut_nfatjet_pre   )
            {
               nPassed_nfatjets+=scaleFactor_TTtoHadronic;
               if( (SJ_nAK4_200[0]>=cut_SJ1_nAK4_200)&&(SJ_nAK4_200[1]>=cut_SJ2_nAK4_200) && (SJ_mass_100[0]>=cut_SJ1_mass_100) && (SJ_mass_100[1]>=cut_SJ2_mass_100)  )nPassed_SJ_nAK4_200+=scaleFactor_TTtoHadronic;
            }
         }
      }
      if((totHT<cut_totHT)||(nbtaggedAK4<cut_nbtaggedAK4))continue;

      if((SJ_nAK4_200[0]<cut_SJ1_nAK4_200)||(SJ_nAK4_200[1]<cut_SJ2_nAK4_200) || (nfatjet_pre < cut_nfatjet_pre)|| (SJ_mass_100[0]<cut_SJ1_mass_100) || (SJ_mass_100[1]<cut_SJ2_mass_100) ) continue;      
      
      if( (superJet_mass[0]/superJet_mass[1] > 1.2)||(superJet_mass[0]/superJet_mass[1] < 0.8)     )continue;
      ntotalevents++;
      ...
      h_superJet_mass_50->Fill(SJ_mass_50[0],scaleFactor_TTtoHadronic);
      h_superJet_mass_50->Fill(SJ_mass_50[1],scaleFactor_TTtoHadronic);

      h_superJet_mass->Fill(superJet_mass[0],scaleFactor_TTtoHadronic);
      h_superJet_mass->Fill(superJet_mass[1],scaleFactor_TTtoHadronic);

      h_diSuperJet_mass->Fill(diSuperJet_mass,scaleFactor_TTtoHadronic);
      h_diSuperJet_mass_100->Fill(diSuperJet_mass_100,scaleFactor_TTtoHadronic);
//(diSuperJet_mass_100 < 4000.)
      if( (superJet_mass[0]/superJet_mass[1] > 0.8)&&(superJet_mass[0]/superJet_mass[1] < 1.25) )
      {
         h_diSuperJet_mass_diag->Fill(diSuperJet_mass,scaleFactor_TTtoHadronic);
         h_Mchichi_vs_Mchi_SJ1_diag->SetPoint(nDiagPoints, superJet_mass[0], diSuperJet_mass);
         nDiagPoints++;
      }
      h_superJet_mass_TH2->Fill(superJet_mass[0],superJet_mass[1],scaleFactor_TTtoHadronic);

      TRandom3 * ran = new TRandom3(0);
      double rannum = ran->Rndm();
      //if(rannum < scaleFactor_TTtoHadronic) 
      ...
      {
        h_SJ_AK4_50_mass->Fill(SJ_AK4_50_mass[iii],scaleFactor_TTtoHadronic);
      }
     for(int iii=0; iii<tot_nAK4_70;iii++)
      {
        h_SJ_AK4_70_mass->Fill(SJ_AK4_70_mass[iii],scaleFactor_TTtoHadronic);
      }
      for(int iii = 0;iii<2;iii++)
      {
        h_SJ_mass_50->Fill(SJ_mass_50[iii],scaleFactor_TTtoHadronic);
        h_SJ_mass_70->Fill(SJ_mass_70[iii],scaleFactor_TTtoHadronic);
        h_SJ_mass_100->Fill(SJ_mass_100[iii],scaleFactor_TTtoHadronic);
      }
      h_nAK4->Fill(nAK4,scaleFactor_TTtoHadronic);
      for(int iii = 0;iii<nAK4;iii++)
      {
         h_AK4_mass->Fill(AK4_mass[iii],scaleFactor_TTtoHadronic);
      }
   ...
   c1->SaveAs("clustAlg_ttbar_ETASORT/Suu4TeV_chi1p5TeV/h_SJ_mass_versus.png");  

   h_nfatjets->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/Suu4TeV_chi1p5TeV/h_nfatjets.png");  
   h_totHT->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/Suu4TeV_chi1p5TeV/h_totHT.png");  
   h_nfatjets_pre->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/Suu4TeV_chi1p5TeV/h_nfatjets_pre.png");  
   h_nbtaggedAk4->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/Suu4TeV_chi1p5TeV/h_nbtaggedAk4.png");  


   h_jet_mass->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/Suu4TeV_chi1p5TeV/h_jet_mass.png");
   
   h_superJet_mass_TH2->Draw("colz");
   c1->SaveAs("clustAlg_ttbar_ETASORT/Suu4TeV_chi1p5TeV/h_superJet_mass_TH2.png");  

   h_diSuperJet_mass_diag->Draw();
   c1->SaveAs("clustAlg_ttbar_ETASORT/Suu4TeV_chi1p5TeV/h_diSuperJet_mass_diag.png"); 
   ...
   c1->SaveAs("clustAlg_ttbar_ETASORT/Suu4TeV_chi1p5TeV/h_SJ_nAK4_100.png");  
   h_SJ_nAK4_200->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/Suu4TeV_chi1p5TeV/h_SJ_nAK4_200.png");  
   h_SJ_nAK4_400->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/Suu4TeV_chi1p5TeV/h_SJ_nAK4_400.png");  
   h_SJ_nAK4_600->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/Suu4TeV_chi1p5TeV/h_SJ_nAK4_600.png");  
   h_SJ_nAK4_800->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/Suu4TeV_chi1p5TeV/h_SJ_nAK4_800.png");  
   h_SJ_nAK4_1000->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/Suu4TeV_chi1p5TeV/h_SJ_nAK4_1000.png");  
   h_superJet_mass->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/Suu4TeV_chi1p5TeV/h_superJet_mass.png");  

   h_SJ_mass_50_versus->Draw("AP*");
   c1->SaveAs("clustAlg_ttbar_ETASORT/Suu4TeV_chi1p5TeV/h_SJ_mass_50_versus.png"); 

   h_SJ_mass_70_versus->Draw("AP*");
   c1->SaveAs("clustAlg_ttbar_ETASORT/Suu4TeV_chi1p5TeV/h_SJ_mass_70_versus.png"); 

   h_SJ_mass_50->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/Suu4TeV_chi1p5TeV/h_SJ_mass_50.png");

   h_SJ_mass_70->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/Suu4TeV_chi1p5TeV/h_SJ_mass_70.png");

   h_SJ_mass_100->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/Suu4TeV_chi1p5TeV/h_SJ_mass_100.png"); 

   h_SJ_AK4_50_mass->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/Suu4TeV_chi1p5TeV/h_SJ_AK4_50_mass.png"); 

   h_SJ_AK4_70_mass->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/Suu4TeV_chi1p5TeV/h_SJ_AK4_70_mass.png");

   h_AK4_mass->Draw("HIST");
   c1->SaveAs("clustAlg_ttbar_ETASORT/Suu4TeV_chi1p5TeV/h_AK4_mass.png");

   h_superJet_mass_comb->Draw("HIST");
   c1->SaveAs("clustAlg_QCD_ETASORT/h_superJet_mass_comb.png");
   h_diSuperJet_mass_comb->Draw("HIST");
   c1->SaveAs("clustAlg_QCD_ETASORT/h_diSuperJet_mass_comb.png");

   h_SJ_mass_50_pre->Draw("HIST");
   c1->SaveAs("clustAlg_QCD_ETASORT/h_SJ_mass_50_pre.png");

   h_SJ_mass_100_pre->Draw("HIST");
   c1->SaveAs("clustAlg_QCD_ETASORT/h_SJ_mass_100_pre.png");

   h_diSuperJet_mass_100->Draw("HIST");
   c1->SaveAs("clustAlg_QCD_ETASORT/h_diSuperJet_mass_100.png");

   h_superJet_mass_avg->Draw("HIST");
   c1->SaveAs("clustAlg_QCD_ETASORT/h_superJet_mass_avg.png");

   h_superJet_mass_50->Draw("HIST");
   c1->SaveAs("clustAlg_QCD_ETASORT/h_superJet_mass_50.png");
