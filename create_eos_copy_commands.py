...
### create_eos_copy_commands.py
### written by Ethan Cannaert, October 2023
### given a list of files on the EOS file system, this script creates the relevant commands to copy these locally (local on the LPC) and merging all files to an irreducible form
