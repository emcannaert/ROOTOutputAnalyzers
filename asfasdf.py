...
fileNames = cms.untracked.vstring("file:UL_files_ALLDECAYS/Suu4TeV_chi500GeV_UL-ALLDECAY.root")
   #fileNames = cms.untracked.vstring("file:Suu4TeV_chi850GeV.root")
   #fileNames = cms.untracked.vstring("/store/mc/RunIIAutumn18MiniAOD/
)
process.TFileService = cms.Service("TFileService",fileName = cms.string("UL_ALLDECAYS_output/ClusteringAlgorithm_Suu4TeV_chi500GeV_ALLDECAYS_output.root"))
...
"""
process.p = cms.Path(process.leptonVeto* process.hadronFilter *process.clusteringAnalyzer)