...
void makeStackedPlotSJMass100()
{
  ...
  TH1F *h_HT1000to1500_HT = (TH1F*)f1->Get("h_lead_SJ_mass_100");
  TH1F *h_HT1500to2000_HT = (TH1F*)f2->Get("h_lead_SJ_mass_100");
  TH1F *h_HT2000toInf_HT = (TH1F*)f3->Get("h_lead_SJ_mass_100");
  ...
  TH1F *h_WJetsToLNu = (TH1F*)f9->Get("h_lead_SJ_mass_100");
  TH1F *h_WJet_QQ = (TH1F*)f10->Get("h_lead_SJ_mass_100");
  TH1F *h_TTToHadronic = (TH1F*)f11->Get("h_lead_SJ_mass_100");
  TH1F *h_TTTo2l2nu = (TH1F*)f12->Get("h_lead_SJ_mass_100");
  TH1F *h_TTToSemiLeptonic = (TH1F*)f13->Get("h_lead_SJ_mass_100");
  ...
  TH1F *h_JetHTA_HT = (TH1F*)f5->Get("h_lead_SJ_mass_100");
  TH1F *h_JetHTB_HT = (TH1F*)f6->Get("h_lead_SJ_mass_100");
  TH1F *h_JetHTC_HT = (TH1F*)f7->Get("h_lead_SJ_mass_100");
  TH1F *h_JetHTD_HT = (TH1F*)f8->Get("h_lead_SJ_mass_100");
  ...
  THStack *hs = new THStack("hs","Data vs MC Lead SuperJet Mass (E_{AK4}>100 GeV); M_{SJ} [GeV]");
  ...
  c1->SaveAs("SJ_mass_100_stack.png"); 
  ...
  c1->SaveAs("tot_SJ_mass_100_ratio.png"); 
