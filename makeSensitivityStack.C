...
void makeSensitivityStack()
{
  ...
  TH2F *h_SJ_mass_DT_HT1500to2000_TH2        = (TH2F*)f2->Get("h_MSJ_mass_vs_MdSJ_DT");
  TH2F *h_SJ_mass_DT_HT2000toInf_TH2         = (TH2F*)f3->Get("h_MSJ_mass_vs_MdSJ_DT");
  TH2F *h_SJ_mass_DT_TTbar                   = (TH2F*)f11->Get("h_MSJ_mass_vs_MdSJ_DT");
  TH2F *h_SJ_mass_DT_Suu5TeV_chi1p5TeV       = (TH2F*)f14->Get("h_MSJ_mass_vs_MdSJ_DT");
  TH2F *h_SJ_mass_DT_Suu8TeV_chi3TeV         = (TH2F*)f13->Get("h_MSJ_mass_vs_MdSJ_DT");
  ...
  TH2F *h_AllBR_combined = new TH2F(*h_SJ_mass_DT_HT2000toInf_TH2);
  h_AllBR_combined->Add(h_SJ_mass_DT_HT1500to2000_TH2);
  h_AllBR_combined->Add(h_SJ_mass_DT_TTbar);


  TH2F *h_SJ_mass_1D_Suu5TeV_chi1p5TeV_sensitivity = new TH2F(*h_SJ_mass_DT_Suu5TeV_chi1p5TeV);
  TH2F *h_SJ_mass_1D_Suu8TeV_chi3TeV_sensitivity = new TH2F(*h_SJ_mass_DT_Suu8TeV_chi3TeV);

  TH2F *h_AllBR_combined_TH1_sqrt = new TH2F(*h_AllBR_combined);  
