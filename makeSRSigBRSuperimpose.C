...
//////////////////shows SR signal MC superimposed on top of SR background
void makeSRSigBRSuperimpose()
{
  ...
  TFile *f4 = new TFile("/home/ethan/Documents/ClusteringAlgorithm_MSuu5TeV-MChi1p5TeV_cutbased_output.root"); 


  std::cout << "Get histograms" << std::endl;
  ///////////////////////////////1000to1500//////////////////////////////////
  TH2F *h_MSJ_mass_vs_MdSJ_SR_HT1000to1500           =      (TH2F*)f1->Get("h_MSJ_mass_vs_MdSJ_DT");
////////////////////////////////////// 1500to2000 /////////////////////////////////////////
...
////////////////////////////////////// MSuu 5 TeV, MChi 1.5TeV /////////////////////////////////////////
  TH2F *h_MSJ_mass_vs_MdSJ_SR_Sig                   =      (TH2F*)f4->Get("h_MSJ_mass_vs_MdSJ_DT");


  std::cout << "Scale histograms 1" << std::endl;

  h_MSJ_mass_vs_MdSJ_SR_HT1000to1500->Scale(QCD_HT1000to1500_SF);
  h_MSJ_mass_vs_MdSJ_SR_HT1500to2000->Scale(QCD_HT1500to2000_SF);
  h_MSJ_mass_vs_MdSJ_SR_HT2000toInf->Scale(QCD_HT2000toInf_SF);
...
///////////h_totHT//////////////////////
  TH2F *h_BR = new TH2F(*h_MSJ_mass_vs_MdSJ_SR_HT1000to1500);    //);
  h_BR->Add(h_MSJ_mass_vs_MdSJ_SR_HT1500to2000);
  h_BR->Add(h_MSJ_mass_vs_MdSJ_SR_HT2000toInf);
  h_BR->SetStats(0);
  ...
  c1->SaveAs("h_2D_SigplusBRoverBR_SR.png");

  h_BR->Draw("colz");
  c1->SaveAs("h_2D_combined_BR_SR.png");

  h_MSJ_mass_vs_MdSJ_SR_Sig->Draw("colz");
  c1->SaveAs("h_MSJ_mass_vs_MdSJ_SR_Sig.png");
