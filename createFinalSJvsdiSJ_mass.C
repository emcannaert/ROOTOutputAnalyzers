...
void makeAllNiceSJvsdiSJ_mass_plots_AltDatasets()
{
  ...
  */
  ...
  double ST_t_channel_top_incl_SF[4] = {0.0409963154,0.03607115071,0.03494669125,0.03859114659}; //TODO
  double ST_t_channel_antitop_inc_SF[4] = {0.05673857623,0.04102705994,0.04238814865,0.03606630944}; //TODO
  double ST_s_channel_hadrons_SF[4] = {0.04668187234,0.03564988679,0.03985938616,0.04102795437}; //TODO
  double fST_s_channel_leptons_SF[4] = {0.01323030083,0.01149139097,0.01117527734,0.01155448784}; //TODO
  double ST_tW_antiTop_incl_SF[4] = {0.2967888696,0.2301666797,0.2556495594,0.2700032391}; //TODO
  double ST_tW_top_incl_SF[4] = {0.2962796522,0.2355829386,0.2563403788,0.2625270613}; //TODO
  ...
  for(auto year = years.begin(); year< years.end(); year++)
  {
    for(auto region = regions.begin();region < regions.end();region++)
    {
      for(auto systematic = systematics.begin();systematic<systematics.end();systematic++)
      {
        ...
        TFile *f1000to1500 = new TFile(("/Users/ethan/Documents/rootFiles/processedRootFiles/QCDMC1000to1500_" + *year + "_"+ *systematic + "_processed.root").c_str());
        TFile *f1500to2000 = new TFile(("/Users/ethan/Documents/rootFiles/processedRootFiles/QCDMC1500to2000_" + *year +"_"+ *systematic + "_processed.root").c_str());
        TFile *f2000toInf  = new TFile(("/Users/ethan/Documents/rootFiles/processedRootFiles/QCDMC2000toInf_" + *year +"_"+ *systematic +"_processed.root").c_str());
        TFile *fTTToHadronic      = new TFile(("/Users/ethan/Documents/rootFiles/processedRootFiles/TTTohadronicMC_" + *year + "_"+ *systematic + "_processed.root").c_str());
        TFile *fTToSemiLeptonic      = new TFile(("/Users/ethan/Documents/rootFiles/processedRootFiles/TTToSemiLeptonicMC_" + *year + "_"+ *systematic +"_processed.root").c_str());
        TFile *fTToLeptonic      = new TFile(("/Users/ethan/Documents/rootFiles/processedRootFiles/TTToLeptonicMC_" + *year +"_"+ *systematic +"_processed.root").c_str());

        TFile *fST_t_channel_top_incl      = new TFile(("/Users/ethan/Documents/rootFiles/processedRootFiles/ST_t-channel-top_inclMC_" + *year +"_"+ *systematic +"_processed.root").c_str());
        TFile *fST_t_channel_antitop_incl      = new TFile(("/Users/ethan/Documents/rootFiles/processedRootFiles/ST_t-channel-antitop_inclMC_" + *year +"_"+ *systematic +"_processed.root").c_str());
        TFile *fST_s_channel_hadrons      = new TFile(("/Users/ethan/Documents/rootFiles/processedRootFiles/ST_s-channel-hadronsMC_" + *year +"_"+ *systematic +"_processed.root").c_str());
        TFile *fST_s_channel_leptons      = new TFile(("/Users/ethan/Documents/rootFiles/processedRootFiles/ST_s-channel-leptonsMC_" + *year +"_"+ *systematic +"_processed.root").c_str());
        TFile *fST_tW_antiTop_incl      = new TFile(("/Users/ethan/Documents/rootFiles/processedRootFiles/ST_tW-antiTop_inclMC_" + *year +"_"+ *systematic +"_processed.root").c_str());
        TFile *fST_tW_top_incl      = new TFile(("/Users/ethan/Documents/rootFiles/processedRootFiles/ST_tW-top_inclMC_" + *year +"_"+ *systematic +"_processed.root").c_str());
        ...
        for(auto systematic_suffix = systematic_suffices.begin(); systematic_suffix < systematic_suffices.end();systematic_suffix++)
        {
            ...
            */
            ...
            std::vector<std::string> samplesData;
             ...
             if(*year == "2015")
             {
                samplesData = {"dataB-ver2_","dataC-HIPM_","dataD-HIPM_","dataE-HIPM_","dataF-HIPM_"}; // dataB-ver1 not present
             }
             else if(*year == "2016")
             {
                samplesData = {"dataF_", "dataG_", "dataH_"};
             }
             else if(*year == "2017")
             {
                samplesData = {"dataB_","dataC_","dataD_","dataE_", "dataF_"};
             }
             else if(*year == "2018")
             {
                samplesData = {"dataA_","dataB_","dataC_","dataD_"};
             }

            // define TH2F histogram here that each data hist will be added to 
            TH2F *h_MSJ_mass_vs_MdSJ_data = new TH2F( ("h_MSJ_mass_vs_MdSJ_" + *region ).c_str(),"Double Tagged Superjet mass vs diSuperjet mass (Signal Region); diSuperjet mass [GeV];superjet mass", 22, 1250., 9500, 20, 500, 3500);  /// 375 * 125
            ...
            for(auto sampleData = samplesData.begin();sampleData < samplesData.end(); sampleData++)
            {
              ...
              // open data file
              TFile *fdata = new TFile(("/Users/ethan/Documents/rootFiles/processedRootFiles/"+ *sampleData+ *year +  "_"+ *systematic+ "_processed.root").c_str());
            ...
            c1->SaveAs( ("/Users/ethan/Documents/plots/finalPlots/M_SJ_vs_M_diSJ_DATA_SR_"+ *year +".png").c_str() ); 
...
void makeAllNiceSJvsdiSJ_mass_plots_CR_sameDatasets()
{
  ...
  for(auto year = years.begin(); year< years.end(); year++)
  {
    ...
    if (*year == "2015")
    {
      dataFileNames = {"dataB-ver2_","dataC-HIPM_","dataD-HIPM_","dataE-HIPM_","dataF-HIPM_"};
    }
    else if (*year == "2016")
    {
      dataFileNames = {"dataF_", "dataG_", "dataH_"};
    }
    else if (*year == "2017")
    {
      dataFileNames = {"dataB_","dataC_","dataD_","dataE_", "dataF_"};
    }
    else if (*year == "2018")
    {
      dataFileNames = {"dataA_","dataB_","dataC_","dataD_"};
    }
    ...
    {
       TFile *fData = new TFile(("/Users/ethan/Documents/rootFiles/processedRootFiles/"+ *dataFile+ "_" + *year +"_processed.root").c_str());
       h_MSJ_mass_vs_MdSJ_SR_data->Add(fData);


    }


    TFile *f1000to1500 = new TFile(("/Users/ethan/Documents/rootFiles/processedRootFiles/QCDMC1000to1500_" + *year +"_processed.root").c_str());
    TFile *f1500to2000 = new TFile(("/Users/ethan/Documents/rootFiles/processedRootFiles/QCDMC1500to2000_" + *year +"_processed.root").c_str());
    TFile *f2000toInf  = new TFile(("/Users/ethan/Documents/rootFiles/processedRootFiles/QCDMC2000toInf_" + *year +"_processed.root").c_str());
    TFile *fTTToHadronic      = new TFile(("/Users/ethan/Documents/rootFiles/processedRootFiles/TTTohadronic_" + *year +"_processed.root").c_str());
    TFile *fTTToSemiLeptonic      = new TFile(("/Users/ethan/Documents/rootFiles/processedRootFiles/TTToSemiLeptonic_" + *year +"_processed.root").c_str());
    TFile *fTTToLeptonic      = new TFile(("/Users/ethan/Documents/rootFiles/processedRootFiles/TTToLeptonic_" + *year +"_processed.root").c_str());
