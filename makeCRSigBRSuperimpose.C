...
//////////////////shows CR signal MC superimposed on top of CR background
void makeCRSigBRSuperimpose()
{
...
////////////////////////////////////// MSuu 5 TeV, MChi 1.5TeV /////////////////////////////////////////
  ...
  h_MSJ_mass_vs_MdSJ_CR_Sig->SetStats(0);
...
///////////h_totHT//////////////////////
  TH2F *h_BR = new TH2F(*h_MSJ_mass_vs_MdSJ_CR_HT1000to1500);    //);
  h_BR->Add(h_MSJ_mass_vs_MdSJ_CR_HT1500to2000);
  h_BR->Add(h_MSJ_mass_vs_MdSJ_CR_HT2000toInf);
  h_BR->SetStats(0);

  TH2F *h_BRplusSig = new TH2F(*h_BR);    //);
  h_BRplusSig->Add(h_MSJ_mass_vs_MdSJ_CR_Sig);
  ...
  c1->SaveAs("h_2D_SigplusBRoverBR_CR.png");

  h_BR->Draw("colz");
  c1->SaveAs("h_2D_combined_BR_CR.png");

  h_MSJ_mass_vs_MdSJ_CR_Sig->Draw("colz");
