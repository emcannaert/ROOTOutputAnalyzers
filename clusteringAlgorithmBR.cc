...
bool clusteringAnalyzerBR::isgoodjet(const float eta, const float NHF,const float NEMF, const size_t NumConst,const float CHF,const int CHM, const float MUF, const float CEMF, int nfatjets)
{
...
double clusteringAnalyzerBR::calc_mass(std::vector<TLorentzVector> candSuperJet)
{
...
bool clusteringAnalyzerBR::isMatchedtoSJ(std::vector<TLorentzVector> superJetTLVs, TLorentzVector candJet)
{
...
bool clusteringAnalyzerBR::fillSJVars(std::map<std::string, float> &treeVars, std::vector<fastjet::PseudoJet> iSJ, int nSuperJets )
{
...
void clusteringAnalyzerBR::analyze(const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
   ...
   for(auto iJet = smallJets->begin(); iJet != smallJets->end(); iJet++) 
   {
      ...
      //std::cout << nGenBJets_AK4[nAK4_gen_bjet_search] << std::endl;
...
//   
   ...
   //std::cout << dijetMassOne << " " << dijetMassTwo << std::endl;
   /*double minDeltaRDisc = 999999999999.;
   dijetMassOne = -99999.;
   dijetMassTwo = -99999.;
   //int iJet1_min = -999, iJet2_min = -999, iJet3_min = -999, iJet4_min = -999;
   for(unsigned int iii =0; iii<leadAK4Jets.size();iii++)
   {
      for(unsigned int jjj =0; jjj<leadAK4Jets.size();jjj++)
      {  


         //////what is going on here? 
         //what are the indices that AREN'T being used
         int iJet1, iJet2,iJet3, iJet4;
         if(jjj==iii)continue;
         if(((iii+jjj) ==1))
         {
            iJet1 = iii;
         ...
         else if(  ((iii == 0) &&(jjj ==2)) || ((iii == 2) &&(jjj ==0))    )
         {
            iJet1 = iii;
            iJet2 = jjj;
            iJet3 = 1;
         ...
         else if(  ((iii == 0) &&(jjj ==3)) || ((iii == 3) &&(jjj ==0))    )
         {
            iJet1 = iii;
            iJet2 = jjj;
            iJet3 = 1;
         ...
         else if(  ((iii == 1) &&(jjj ==2)) || ((iii == 2) &&(jjj ==1))    )
         {
            iJet1 = iii;
            iJet2 = jjj;
            iJet3 = 0;
         ...
         else if(  ((iii == 1) &&(jjj ==3)) || ((iii == 3) &&(jjj ==1))    )
         {
            iJet1 = iii;
            iJet2 = jjj;
            iJet3 = 0;
         ...
         else if(  ((iii == 2) &&(jjj ==3)) || ((iii == 3) &&(jjj ==2))    )
         {
            iJet1 = iii;
            iJet2 = jjj;
            iJet3 = 0;
         ...
         else {std::cout << "Somehow missed out on the if statements " << iii << "  " << jjj << " " << iJet3 << " " << iJet4 << std::endl;}
         if(sqrt( pow(leadAK4Jets[iJet1].DeltaR(leadAK4Jets[iJet2]),2) + pow(leadAK4Jets[iJet3].DeltaR(leadAK4Jets[iJet4]),2) ) < minDeltaRDisc  )
         {
            ...
            //iJet3_min = iJet3;
            //iJet4_min = iJet4;
            minDeltaRDisc = sqrt( pow(leadAK4Jets[iJet1].DeltaR(leadAK4Jets[iJet2]),2) + pow(leadAK4Jets[iJet3].DeltaR(leadAK4Jets[iJet4]),2));
            dijetMassOne = (leadAK4Jets[iJet1] +leadAK4Jets[iJet2]).M();
            dijetMassTwo = (leadAK4Jets[iJet3] +leadAK4Jets[iJet4]).M();
            //std::cout << dijetMassOne  << " " << dijetMassTwo << std::endl;
